...
const UserListItem = ({ user, handleScrollClick }) => {
  const notActiveClass =
    "mt-3 px-4 shadow-sm bg-slate-100 w-full py-3 cursor-pointer rounded-sm flex items-center relative transition-all duration-100 ease-in before:absolute before:top-0 before:left-1/2 before:-translate-x-1/2 before:w-0 before:h-full before:bg-gray-200/70 before:-z-10 z-10 before:transition-all before:duration-200 before:rounded-sm hover:before:w-full hover:-translate-y-[2px]";
  const activeClass =
